...
- キャラ選択でP1だけが決定するとP2はCPUになり、1人で対戦できます。
...
タイトルはW/Sで選びJで決めます。キャラ選択でJを押すとP1が決定し、3秒以内にテンキー1が押されなければP2はCPUになります。Kで次のステージへ、LでCPUの強さ（やさしい、ふつう、つよい）を切り替え、Escで戻ります。リザルトはJでタイトルへ戻り、トレーニングはEscで終わります。

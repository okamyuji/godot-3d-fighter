...
3. 箱同士で格闘コアと画面の流れを作る 固定のフレーム更新、コマンド入力と先行入力、歩き、ダッシュ、横移動、しゃがみ、上段・中段・下段とガード、投げと投げ抜け、カウンターヒット、ダウンと起き上がり、リングアウト、ラウンドの決着を実装します。タイトル、キャラ選択、試合、リザルト、トレーニングの画面と遷移もここで作り、主要導線をすべて走破します。Virtua Fighterらしさはここでほぼ決まります。
